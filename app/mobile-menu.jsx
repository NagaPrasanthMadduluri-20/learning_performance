        ...
        <Suspense
          fallback={
            ...
            >
              ...
              >
                <Skeleton className="h-4 w-[300px] bg-gray-400 mt-20 mb-5" />
                <Skeleton className="h-4 w-[250px] bg-gray-400 mb-5" />
                <Skeleton className="h-4 w-[200px] bg-gray-400 mb-5" />
                <Skeleton className="h-4 w-[150px] bg-gray-400 mb-5" />
              </div>
            </div>
          }
        >
                                          ...
                                          {list.Acc && (
                                            <>
                                              ...
                                              <Separator
                                                ...
                                                className="h-3 w-[2px] opacity-65 mx-3"
                                              />
                                            </>
                                          )}
                                          {list.d ? (
